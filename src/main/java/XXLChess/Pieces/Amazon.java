...
public class Amazon extends Piece implements Jump {
     ...
     * @param image, image
     */
    public Amazon(String name, double value, String colour, int x, int y, PImage image) {
        super(name, value, colour, x, y, image);
    }

    /**
     * Returns jump directions of amazon
     */
